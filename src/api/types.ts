...
export interface DriveboxItem {
  id: string;
  deal_id: number;
  channel: "telegram" | "avito" | "calls";
  type: string;
  external_id: string;
  title?: string | null;
  preview?: string | null;
  ...
  created_at: string;
  is_unread?: boolean;
  // Additional fields from deal
  from_location?: string | null;
  to_location?: string | null;
  contact_name?: string | null;
  contact_phone?: string | null;
  call_status?: string | null;
  call_direction?: "in" | "out" | null;
  call_duration_sec?: number | null;
}

export interface DriveboxGroup {
  deal_id: number;
...
export interface DriveboxResponse {
  items?: DriveboxItem[] | null;
  groups?: DriveboxGroup[] | null;
  unread_count: number;
  total?: number;
  has_more?: boolean;
